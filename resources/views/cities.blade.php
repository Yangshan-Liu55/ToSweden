                ...
                <div class="row row-wrap">
                    <div class="col col-12 col-md-6 p-0 hovereffect">
                        ...
                        <span id="city-hero"><img ng-src="/img/skrivstil/@{{city.cities_head_img}}"></span>
                            <a href="city?nr=@{{city.id}}" class="hidetexttwo"><span class="bottomlay hidetexttwo fadeBGcolor" style="color:white;" >KLICK FÖR ATT SE MER</span></a>                    
                            <a href="city?nr=@{{city.id}}" class="btn overlay"><span class="bottomlay fadeBGcolor">KLICK FÖR ATT SE MER</span></a>                   
                    </div>
